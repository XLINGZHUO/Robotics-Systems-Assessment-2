...
#define ENCODER_0_A_PIN  7 // right encoder XORed signal
#define ENCODER_0_B_PIN  23 // right encoder channel B
#define ENCODER_1_A_PIN  26 // Left encoder XORed input
// #define ENCODER_1_B_PIN PE2 
//Non-standard pin,(Do not need definition?)
...
ISR( INT6_vect ) {
  ...
  // State:  new B   new A   old B   old A
    ...
    if( state_e0 == 0 |state_e0 == 3 |state_e0 == 5 |state_e0 == 6 
    | state_e0 == 9 | state_e0 == 12 | state_e0 == 15 ) {
      //do nothing
    } else if( state_e0 == 1 | state_e0 == 7 | state_e0 == 8 | 
    state_e0 == 14 ) {
      count_e0 = count_e0 + 1;
    } else if( state_e0 == 2 | state_e0 == 4 | state_e0 == 11 | 
    state_e0 == 13 ) {
      count_e0 = count_e0 - 1;
...
ISR( PCINT0_vect ) {
    ...
    // Complete this if statement as necessary.
    // Refer to the labsheet. 
    if( state_e1 == 0 |state_e1 == 3 |state_e1 == 5 |state_e1 == 6 
    | state_e1 == 9 | state_e1 == 12 | state_e1 == 15 ) {
      //do nothing
    } else if( state_e1 == 1 | state_e1 == 7 | state_e1 == 8 | 
    state_e1 == 14 ) {
      count_e1 = count_e1 + 1;
    } else if( state_e1 == 2 | state_e1 == 4 | state_e1 == 11 | 
    state_e1 == 13 ) {
      count_e1 = count_e1 - 1;
    } // Continue this if statement as necessary.
