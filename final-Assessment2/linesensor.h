...
class LineSensor_c {
  ...
  unsigned long Base_m[SelectionPINS]= {409,409,500,540,504};//create an array. 
  unsigned long Sum;
...
////calibrate fucntion
void calibrate(){
  //Black reading base. Reads four sets of values
  int i;
  int j;
  int which;
...
////LineError Function
  ...
  DN1 = double(sensor_read[3])/Base_m[3]*2.3;
